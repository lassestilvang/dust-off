...
- [ ] **8. Side-by-side diff view (source → target)**
  The biggest missing UX feature. Users want to see the *old file* next to the *new file* for each component, with a diff highlight showing what changed. This is the killer feature for a migration tool.
...
- [ ] **20. Persistent state / session recovery**
...
- [ ] **21. Progress indicator for repo migration**
